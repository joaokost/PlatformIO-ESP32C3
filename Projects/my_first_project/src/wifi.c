...
static void request_page(void *arg)
{
    esp_http_client_config_t config = {
        .url = "https://github.com/espressif/esp-idf/blob/master/examples/get-started/blink/main/blink_example_main.c",
